        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionExpirationDate = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconIndex = table.Column<int>(nullable: true),
                    OrganizationId = table.Column<int>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TargetTemplates_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetTemplateId = table.Column<Guid>(nullable: true),
                    CreatedBy = table.Column<string>(nullable: true),
                    UpdatedBy = table.Column<string>(nullable: true),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    UpdatedDate = table.Column<DateTime>(nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_TargetTemplates_TargetTemplateId",
                        column: x => x.TargetTemplateId,
                        principalTable: "TargetTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Summary = table.Column<string>(maxLength: 30, nullable: true),
                    Note = table.Column<string>(nullable: true),
                    Location = table.Column<string>(nullable: true),
                    IsReminderOn = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DealAmount = table.Column<double>(nullable: false),
                    ...
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    UpdatedDate = table.Column<DateTime>(nullable: false),
                    ChangeStageDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pipelines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pipelines_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pipelines_Peoples_PeopleId",
                        column: x => x.PeopleId,
                        principalTable: "Peoples",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pipelines_Stages_StageId",
                        column: x => x.StageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_Pipelines_PipelineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PipelineId",
                table: "Appointments",
                column: "PipelineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TargetTemplateId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pipelines_ApplicationUserId",
                table: "Pipelines",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pipelines_PeopleId",
                table: "Pipelines",
                column: "PeopleId");

            migrationBuilder.CreateIndex(
                name: "IX_Pipelines_StageId",
                table: "Pipelines",
                column: "StageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TargetTemplates_OrganizationId",
                table: "TargetTemplates",
                column: "OrganizationId");
